               ...
               <div class="row">
                    ...
                    <div class="col-xl-10 col-12">
                         <div class="d-flex justify-content-center">
                              <h3 class="admin-head-txt mb-0" id="admin-head-txt"><?php echo isset($row['fullname']) ? 'Update User' : 'Registered Users'; ?></h3>   
                         </div>
                         <div class="d-flex justify-content-center">
                         ...
                         <div class="d-flex justify-content-center">
                              <div class="admin-section">
                                   ...
                                   <form method="POST" action="Manage_Registered_Users.php">
                                        ...
                                        ?>
                                        <button type="submit" class="btn-a buttons">   <?php echo isset($client_id) ? 'Save' : 'Save'; ?>   </button>
                                        <a href="Registered_Users.php" class="btn-b buttons">Cancel</a>
                                   </div>
                              </div>
                         </div>
                    </div>
