               ...
               <div class="row">
                    ...
                    <div class="col-xl-10 col-12">
                         <div class="d-flex justify-content-center">
                              <h3 class="admin-head-txt mb-0">Client</h3>
                         </div>
                         <div class="d-flex justify-content-center">
                         ...
                         <div class="d-flex justify-content-center">
                              <div class="admin-section">
                                   <div class="d-flex justify-content-end">
                                        <!-- <a href="Registered_Users_Form.php" class="mb-2 btn-a">Add User</a> -->
                                   </div>
                                        ...
                                        if (!$result) {
                                             ...
                                             while ($row = mysqli_fetch_assoc($result)) {
                                                  echo '<tr>
                                                            ...
                                                            <td>
                                                            <a href="Registered_Users_Form.php?client_id=' . $row['client_id'] . '" class="btn-edit">Edit</a>
                                                            <a href="Delete_Registered_Users.php?client_id=' . $row['client_id'] . '" class="btn-delete">Delete</a>
                                                       </td>
                                                       </tr>';
                                             }
