...
<head>
    ...
    <style>
        ...
        .registration-input, .register-btn, .registration-input:active {
            ...
            <div>
                ...
                <form method="POST" action="">
                    <div class="mb-3">
                        ...
                        <input type="text" class="registration-input form-control" id="fullname" name="fullname" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="registration-input form-control input-number-only" id="mobile_number" name="mobile_number" required>
                    </div>
                    <div class="mb-3">
