<?php
     ...
     $query = "INSERT INTO service_request (car_model, car_brand, car_reg_num, service_type, car_problem, request_date, client_id, request_status) VALUES (?, ?, ?, ?, ?, NOW(), ? , ?)";
     ...
     mysqli_stmt_bind_param($stmt, 'sssssii', $car_model, $car_brand, $car_reg_num, $service_type, $car_problem, $client_id, $status);
