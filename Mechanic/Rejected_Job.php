<?php
   ...
   $query = "SELECT sc.request_id, cl.fullname, cl.mobile_number, cl.email,
          ...
          WHERE sc.mechanic_id = $mechanic_id AND sc.service_status_id = 3";
...
<html lang="en">
     ...
     <body>
               ...
               <div class="row">
                    ...
                    <div class="col-xl-10 col-12">
                         <div class="d-flex justify-content-center">
                              <h3 class="mechanic-head-txt mb-0">Rejected Job Assignment</h3>
                         </div>
                         <div class="d-flex justify-content-center">
          ...
          <script>document.getElementById('rejected-job').style = "border: 3px solid black;";</script>
     </body>
</html>